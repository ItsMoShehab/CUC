...
namespace ConnectionCUPIFunctionsTest
{
    ...
    public class CosUnitTest : BaseUnitTests
    {
        ...
        public void StaticMethodFailures_DeleteClassOfService()
        {
            ...
            res = ClassOfService.DeleteClassOfService(_mockServer, "");
        ...
        public void StaticMethodFailures_GetClassOfService()
        {
            ...
            res = ClassOfService.GetClassOfService(out oCos, _mockServer);
        ...
        public void StaticMethodFailures_UpdateClassOfService()
        {
            ...
            res = ClassOfService.UpdateClassOfService(_mockServer, "bogus", null);
            Assert.IsFalse(res.Success, "Static call to UpdateClassOfService did not fail with: invalid objectId");

            res = ClassOfService.UpdateClassOfService(_mockServer, "", null);
        ...
        public void StaticMethodFailures_AddClassOfService()
        {
            ...
            res = ClassOfService.AddClassOfService(_mockServer, "", null);
        ...
        public void GetClassesOfService_HarnessTestFailures()
        {
            ...
            res = ClassOfService.GetClassesOfService(_mockServer, out oCoses, 1, 5, "InvalidResultText");
            ...
            res = ClassOfService.GetClassesOfService(_mockServer, out oCoses, 1, 5, "ErrorResponse");

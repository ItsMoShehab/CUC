...
6. You will need to configure the "ExtensionToDial" property in the setting and then answer that phone and record a message for these tests to pass and, of course, 
